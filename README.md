...
This repository contains example CDS (Dynamics 365) plugin implementation, realized by [CDS Plugin Development Framework](https://appsource.microsoft.com/en/product/dynamics-365/innovationonesro1585927428411.plugindevframework?tab=Overview). Source codes in this repository are only for example and cannot be used for deployment to CDS. For more information contact us on email [jan.mucha@innone.cz](mailto:jan.mucha@innone.cz?subject=CDS%20Plugin%20Development%20Framework)
